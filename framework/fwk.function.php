...
function message($type, $message) {
    echo "<p class='msg_{$type}'><span style='font-size: 20px;'>" . ucfirst($type) . "</span><br /><br />" . $message . "<a style='margin-right: 0px; margin-top: -40px;' title='Fechar mensagem' class='msg_back' href='javascript:history.back();'><img src='media/image/back.png' /></a></p>";
    return;
}
