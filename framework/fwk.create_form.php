...
class CreateForm {
    ...
    function __construct($fwk_operation_id, $back_operation_id, $fields, $has_title=true) {
    ...
    private function write_home_title() {
        ...
        if ($this->operation) {
            ...
            if ($back_operation) {
                ...
                echo "<p>\n";
                echo "<a title='{$back_operation['description']}' href='?operation={$this->back_operation_id}&{$this->back_operation_param}';>\n";
