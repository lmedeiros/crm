<?php
    ...
    $fields = array(
        ...
        new Field("combo", "Sellers", "sys_seller_id", "", "SELECT sys_seller_id, fullname FROM sys_seller S INNER JOIN fwk_user U on U.fwk_user_id = S.fwk_user_id AND S.sys_seller_id != '" . $_GET['seller_id'] . "' UNION SELECT '0' as sys_seller_id,'DEALLOCATE' as fullname", "Sellers", 10, true, "sys_seller_id", "fullname")
    );
